...
function flashing_win(ln)
    ...
    rainbow_text(ln, 'P', - 78, 40)
    ln = next_color(ln)

    rainbow_text(ln, 'l', - 68, 40)
    ln = next_color(ln)

    rainbow_text(ln, 'a', - 57, 40)
    ln = next_color(ln)
   
    rainbow_text(ln, 'y', - 42, 40)
    ln = next_color(ln)

    rainbow_text(ln, 'e', - 27, 40)
    ln = next_color(ln)

    rainbow_text(ln, 'r', - 14, 40)
    ln = next_color(ln)

    if winningPlayer == 1 then
        rainbow_text(ln, '1', 9, 40)

    elseif winningPlayer == 2 then
        rainbow_text(ln, '2', 9, 40)
    end
    ln = next_color(ln)

    rainbow_text(ln, 'w', 34, 40)
    ln = next_color(ln)

    rainbow_text(ln, 'i', 46, 40)
    ln = next_color(ln)

    rainbow_text(ln, 'n', 57, 40)
    ln = next_color(ln)

    rainbow_text(ln, 's', 72, 40)
    ln = next_color(ln)

    rainbow_text(ln, '!', 82, 40)
    ln = next_color(ln)
end
